...
id: ""
<!-- title: Slice title, copied from the slice frontmatter. -->
title: ""
from: rom
to: obrien
<!-- status: DONE = all criteria met. PARTIAL = some done, some not. BLOCKED = need O'Brien's input. -->
status: DONE
<!-- commission_id: ID of the slice this report responds to. Usually same as id. -->
commission_id: ""
...
tokens_out: 0
<!-- elapsed_ms: Wall-clock ms from slice pickup to DONE (positive integer). -->
elapsed_ms: 0
